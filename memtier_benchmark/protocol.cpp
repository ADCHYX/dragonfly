...
public:
    ...
    virtual int write_command_set_index(const char *key, int key_len, const char *value, int value_len, int expiry, unsigned int offset);
    virtual int write_command_get_index(const char *key, int key_len, unsigned int offset);
...
void print_evbuffer(struct evbuffer *buf) {
    ...
    if (data != NULL) {
        ...
        printf("Failed to get data from evbuffer.\n");
    }
}
...
int redis_protocol::write_command_set_index(const char *key, int key_len, const char *value, int value_len, int expiry, unsigned int offset)
{
    assert(key != NULL);
    assert(key_len > 0);
    assert(value != NULL);
...
int redis_protocol::write_command_get_index(const char *key, int key_len, unsigned int offset)
{
    assert(key != NULL);
    assert(key_len > 0);
    int size = 0;
...
int memcache_text_protocol::write_command_set_index(const char *key, int key_len, const char *value, int value_len, int expiry, unsigned int offset)
{
    return 0;
}
...
int memcache_text_protocol::write_command_get_index(const char *key, int key_len, unsigned int offset)
{
    return 0;
}
...
int memcache_binary_protocol::write_command_set_index(const char *key, int key_len, const char *value, int value_len, int expiry, unsigned int offset)
{
    return 0;
}
...
int memcache_binary_protocol::write_command_get_index(const char *key, int key_len, unsigned int offset)
{
    return 0;
}
