...
public:
    ...
    virtual int write_command_set_index(const char *key, int key_len, const char *value, int value_len, int expiry, unsigned int offset) = 0;
    virtual int write_command_get_index(const char *key, int key_len, unsigned int offset) = 0;
