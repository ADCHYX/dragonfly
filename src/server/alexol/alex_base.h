...
constexpr inline double kExpSearchIterationsWeight = 20;
constexpr inline double kShiftsWeight = 0.5;

// TraverseToLeaf cost weights
constexpr inline double kNodeLookupsWeight = 20;
constexpr inline double kModelSizeWeight = 5e-7;
